...
//※サクラ依存
void GetExedir( LPWSTR pDir, size_t nLen, LPCWSTR szFile = nullptr );
void GetInidir( LPWSTR pDir, size_t nLen, LPCWSTR szFile = nullptr ); // 2007.05.19 ryoji
void GetInidirOrExedir( LPWSTR pDir, size_t nLen, LPCWSTR szFile = nullptr, BOOL bRetExedirIfFileEmpty = FALSE ); // 2007.05.22 ryoji
